...
import com.qiyei.architecture.ui.activity.DataBindingActivity;
...
import com.qiyei.architecture.ui.activity.SQLiteDemoActivity;
import com.qiyei.architecture.ui.activity.ViewBindingActivity;
...
public class ArchitectureFragment extends CommonListFragment {
    ...
    private String[] names = new String[]{"测试1 动态代理","测试2 数据中心","测试3 进程保活","测试4 Binder测试"
            ...
            ,"测试13 SQLite架构测试","测试14 DataBinding","测试15 ViewBinding","测试16 MVVM + DataBinding + ViewModel"};
    private Class<?>[] clazzs = new Class[]{ProxyTestActivity.class,DataCenterTestActivity.class,ProcessKeepAliveActivity.class,BinderTestActivity.class
            ...
            , PagingDemoActivity.class, NavigationDemoActivity.class, MovieListActivity.class, SQLiteDemoActivity.class, DataBindingActivity.class
            , ViewBindingActivity.class,DataBindingActivity.class};
