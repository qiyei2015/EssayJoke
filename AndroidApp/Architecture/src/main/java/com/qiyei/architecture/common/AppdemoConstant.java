package com.qiyei.architecture.common;
...
public class AppdemoConstant {
     ...
     * 存储在SP中，多用户共享数据
     */
    public static class StoreData extends DC.StoreData{
     ...
     * 用户数据存储在SP中，单一用户共享
     */
    public static class UserData extends DC.UserData{
     ...
     * 运行时数据
     */
    public static class MemoryData extends DC.MemoryData{
