 ...
 */
public class FragmentLazyLoadOnePagerAdapter extends FragmentPagerAdapter {
     ...
     */
    @Deprecated
    public FragmentLazyLoadOnePagerAdapter(@NonNull FragmentManager fm) {
        super(fm);
    }
     ...
     * @param behavior
     */
    public FragmentLazyLoadOnePagerAdapter(@NonNull FragmentManager fm, int behavior) {
        super(fm, behavior);
    }
    ...
    public Fragment getItem(int position) {
        return new MyFragment("懒加载方式1 ViewPager ->> " + position);
    }
    ...
    public static class MyFragment extends FragmentLazyLoadOne{
